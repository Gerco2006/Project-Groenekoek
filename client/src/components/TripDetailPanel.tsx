...
import { X, Clock, AlertCircle, Navigation, Loader2, Info, Train, Wifi, UtensilsCrossed, Accessibility, BatteryCharging, ChevronDown, ChevronUp, ChevronLeft, Droplet, Bike, Users, Link, Unlink } from "lucide-react";
  ...
  if (isMobile) {
    ...
    return (
      <div
        ...
        data-testid="panel-trip-detail-mobile-fullscreen"
      >
        {/* Fixed header */}
        <div className="flex items-center gap-1 px-1 py-2 border-b shrink-0">
          <Button
            ...
            data-testid="button-back-mobile-train-detail"
          >
          ...
          <div className="flex items-center gap-2 min-w-0 flex-1">
            ...
            <span className="text-sm font-medium truncate">{displayFrom} → {displayTo}</span>
          </div>
          {onBack && (
            <Button
              variant="ghost"
