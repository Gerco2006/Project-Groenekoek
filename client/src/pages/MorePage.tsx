          ...
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>De reisplanner die net wat meer kan</CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-center space-y-2">
                <p className="text-sm text-muted-foreground">Versie 0.6.4-Alpha.2</p>
                <p className="text-xs text-muted-foreground">Gemaakt met React, TypeScript en de NS API</p>
              </div>
            </CardContent>
          </Card>
        </div>
