...
export default function JourneyPlanner() {
    ...
    const legs: TripLeg[] = trip.legs
      ...
      ?.map((leg: any) => {
        ...
        return {
          ...
          numberOfCarriages: typeof leg.numberOfCarriages === 'number' ? leg.numberOfCarriages : undefined,
        };
      }) || [];
          ...
          <div className="space-y-2">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="outline"
                  className="w-full justify-start text-left font-normal bg-muted/60"
  ...
  const masterContent = (
    <div className="h-full flex flex-col">
      <div className="shrink-0 md:px-4 pt-0 pb-3 md:py-6 space-y-6">
